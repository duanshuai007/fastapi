  ...
  <div>
    <v-navigation-drawer persistent :mini-variant="miniDrawer" v-model="showDrawer" fixed app>
      <v-layout column fill-height>
        ...
        <v-divider></v-divider>
        <v-list subheader v-show="hasAdminAccess">
            <v-subheader>IotDevices</v-subheader>
            <v-list-tile to="/main/admin/users/device/manage">
                <v-list-tile-action>
                    <v-icon>group</v-icon>
                </v-list-tile-action>
                <v-list-tile-content>
                    <v-list-tile-title>Manage Devices</v-list-tile-title>
                </v-list-tile-content>
            </v-list-tile>

            <v-list-tile to="/main/admin/users/device/create">
                <v-list-tile-action>
                    <v-icon>person_add</v-icon>
                </v-list-tile-action>
                <v-list-tile-content>
                    <v-list-tile-title>Create Devices</v-list-tile-title>
                </v-list-tile-content>
            </v-list-tile>
        </v-list>
        ...
        <v-divider></v-divider>
        <v-list subheader v-show="hasAdminAccess">
            <v-subheader>IotDevicesShow</v-subheader>
            <v-list-tile to="/main/admin/users/device/iot">
                <v-list-tile-action>
                    <v-icon>group</v-icon>
                </v-list-tile-action>
                <v-list-tile-content>
