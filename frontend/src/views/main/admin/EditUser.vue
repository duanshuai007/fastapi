<template>
  <v-container fluid>
    <v-card class="ma-3 pa-3">
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn @click="deluser">Delete</v-btn>
...
import { dispatchGetUsers, dispatchUpdateUser, dispatchDeleteUser } from '@/store/admin/actions';
...
export default class EditUser extends Vue {
  ...
  public async deluser() {
    if (await this.$validator.validateAll()) {
        await dispatchDeleteUser(this.$store, this.user!.id);
